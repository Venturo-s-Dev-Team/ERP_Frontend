    ...
    <main className="main-container">
      ...
      {formType === "CPF" && (
        ...
        >
          <div className="DivModal1">
            <h1>
              {isEditMode ? "Editar Cliente (CPF)" : "Registrar Cliente (CPF)"}
            </h1>
            <form>
              <input
                type="text"
          ...
          <div className="perfil-cliente">
            ...
            <div className="container-infos">
              ...
              <div className="info-card">
                ...
                <p>
                  <strong>Funcionário:</strong> {SelectedCliente.funcionario}
                </p>
                <p>
                ...
                <p>
                  <strong>Autorizados:</strong> {SelectedCliente.autorizados}
                </p>
                <p>
                  <strong>Observações:</strong> {SelectedCliente.observacoes}
                </p>
              </div>
            </div>
