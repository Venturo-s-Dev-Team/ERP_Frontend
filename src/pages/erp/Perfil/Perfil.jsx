              ...
              <details className="perfil-details">
                <summary className="perfil-summary">
                  {!userInfo.id_EmpresaDb ? (
                    ...
                    <img src={`http://10.144.170.24:3001/uploads/Logo/${userInfo.id_EmpresaDb}.png`} style={{ width: 100, height: 100 }} alt="" />
                  )}
                </summary>
                <p className="perfil-id">ID: {userInfo.id_user}</p>
                <p className="perfil-nome">Nome: {userInfo.Nome_user}</p>
              ...
              <details className="perfil-details">
                <summary className="perfil-summary">
                  {!userInfo.Logo ? (
                    ...
                    <img src={`http://10.144.170.24:3001/uploads/Logo/${userInfo.Logo}`} style={{ width: 100, height: 100 }} alt="" />
                  )}
                </summary>
                <p className="perfil-id">ID: {userInfo.id_user}</p>
                <p className="perfil-nome">Nome: {userInfo.Nome_user}</p>
