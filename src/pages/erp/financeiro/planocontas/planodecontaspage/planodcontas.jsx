...
const fetchPlanos = async (id) => {
    try {
        ...
        setPlanos(response.data.InfoTabela); // Agora pegamos a propriedade InfoTabela da resposta
    } catch (error) {
    ...
    const handleContaSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`/api/ServerTwo/registrarContas/${id}`, contaData);
                            ...
                            <div className="edit-item">
                                ...
                                <div className="form-item">
                                    <form onSubmit={handleContaSubmit}>
                                        ...
                                        <button className="button-update" type="submit">Salvar</button>
                                    </form>
                                </div>
                            </div>
                        </div>
