...
/**
* Converte data ISO para formato de data e horário legível
* @param {string} dataISO - Data no formato ISO (ex: 2024-10-02T21:55:50.000Z)
* @returns {string} Data e horário formatados
*/
export const converterDataHora = (dataISO) => {
  if (!dataISO) return '';
